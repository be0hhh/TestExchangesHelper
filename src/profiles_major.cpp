...
void append_major_profiles(std::vector<ProductSpec>& products) {
  ...
  products.push_back(ProductSpec{
      ...
      .public_rest = {
          ...
          public_rest(
              ...
              "BTCUSDT",
              anchor(
                  "src/src/exchanges/binance/fapi/ReferenceCatalogV1.hpp")),
          public_rest(
              "funding_current",
              "fapi.binance.com",
  ...
  products.push_back(ProductSpec{
      ...
      .public_rest = {
          ...
          public_rest(
              ...
              "BTCUSDT",
              anchor(
                  "src/src/exchanges/bybit/linear/ReferenceCatalogV1.hpp")),
          public_rest(
              "funding_current",
              "api.bybit.com",
              "/v5/market/tickers?category=linear",
              ...
              "BTCUSDT",
              anchor(
                  "src/src/exchanges/bybit/linear/FundingCurrentCatalogV1.hpp")),
  ...
  products.push_back(ProductSpec{
      ...
      .public_rest = {
          ...
          public_rest(
              ...
              "BTC-USDT-SWAP",
              anchor(
                  "src/src/exchanges/okx/swap/ReferenceCatalogV1.hpp")),
          public_rest(
              "funding_current",
              "www.okx.com",
              "/api/v5/public/funding-rate?instId=BTC-USDT-SWAP",
              ...
              "BTC-USDT-SWAP",
              anchor(
                  "src/src/exchanges/okx/swap/FundingCurrentCatalogV1.hpp")),
  ...
  products.push_back(ProductSpec{
      .venue = "gate",
      .product = "futures",
      .credential_prefix = "GATE_FUTURES_API",
      .public_rest = {
          public_rest(
              "instrument_rules",
              "api.gateio.ws",
          ...
          public_rest(
              ...
              "BTC_USDT",
              anchor(
                  "src/src/exchanges/gate/usdt/ReferenceCatalogV1.hpp")),
          public_rest(
              "funding_current",
              "api.gateio.ws",
              "/api/v4/futures/usdt/contracts",
              ...
              "BTC_USDT",
              anchor(
                  "src/src/exchanges/gate/usdt/FundingCurrentCatalogV1.hpp")),
  ...
  products.push_back(ProductSpec{
      ...
      .public_rest = {
          ...
          public_rest(
              ...
              "XBTUSDTM",
              anchor(
                  "src/src/exchanges/kucoin/uta/ReferenceCatalogV1.hpp")),
          ...
          public_rest(
              ...
              "XBTUSDTM",
              anchor(
                  "src/src/exchanges/kucoin/uta/FundingCurrentCatalogV1.hpp")),
          public_rest(
              "funding_history",
              "api-futures.kucoin.com",
  ...
  products.push_back(ProductSpec{
      ...
      .public_rest = {
          ...
          public_rest(
              ...
              "BTCUSDT",
              anchor(
                  "src/src/exchanges/bitget/uta/ReferenceCatalogV1.hpp")),
          public_rest(
              "funding_current",
              "api.bitget.com",
              ...
              "BTCUSDT",
              anchor(
                  "src/src/exchanges/bitget/uta/FundingCurrentCatalogV1.hpp")),
          public_rest(
              "funding_lowercase",
              "api.bitget.com",
