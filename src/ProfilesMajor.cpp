  ...
  products.push_back(ProductSpec{
      ...
      .public_rest = {
          ...
          public_rest(
              ...
              "BTCUSDT",
              anchor(
                  "src/src/Core/include/cxet/Exchanges/Binance/Fapi/Market/Funding/FundingCurrentCatalog.hpp")),
          std::move(binance_lowercase),
          public_rest(
              "funding_history",
              "fapi.binance.com",
  ...
  products.push_back(ProductSpec{
      ...
      .public_ws = {
          json_ws(
              ...
              {"live_trades"},
              anchor(
                  "src/src/Core/src/Exchanges/Bybit/Spot/Config.cpp",
                  "kSubscribeTrades"),
  ...
  products.push_back(ProductSpec{
      ...
      .public_rest = {
          ...
          public_rest(
              ...
              "BTCUSDT",
              anchor(
                  "src/src/Core/include/cxet/Exchanges/Bybit/Linear/Reference/ReferenceCatalog.hpp")),
          public_rest(
              "funding_current",
              "api.bybit.com",
              "/v5/market/tickers?category=linear",
              ...
              "BTCUSDT",
              anchor(
                  "src/src/Core/include/cxet/Exchanges/Bybit/Linear/Market/Funding/FundingCurrentCatalog.hpp")),
      ...
      .public_ws = {
          json_ws(
              ...
              {"funding_current_symbol"},
              anchor(
                  "src/src/Core/src/Exchanges/Bybit/Linear/Config.cpp",
                  "kSubscribeFunding"),
              WsAckKind::BybitSubscription,
              "tickers",
              "BTCUSDT"),
  ...
  products.push_back(ProductSpec{
      ...
      .public_rest = {
          ...
          public_rest(
              ...
              "BTC-USDT-SWAP",
              anchor(
                  "src/src/Core/include/cxet/Exchanges/Okx/Swap/Market/Funding/FundingCurrentCatalog.hpp")),
  ...
  products.push_back(ProductSpec{
      ...
      .public_rest = {
          ...
          public_rest(
              ...
              "BTCUSDT",
              anchor(
                  "src/src/Core/include/cxet/Exchanges/Bitget/Uta/Market/Funding/FundingCurrentCatalog.hpp")),
          public_rest(
              "funding_lowercase",
              "api.bitget.com",
