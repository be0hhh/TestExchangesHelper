...
#include "cxet/Exchanges/Binance/Fapi/Wire/EndpointProfiles.hpp"
...
VenueFeedPlan binance() {
  VenueFeedPlan out{
      ...
      .instruments = {
          Venue::BinanceUsdM,
          cxet::exchanges::binance::fapi::wire::kRestHost,
          cxet::exchanges::binance::fapi::wire::kExchangeInfoPath},
      .feeds = {},
  };
