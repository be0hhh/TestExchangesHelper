...
_BASE_PRODUCTS: tuple[ProductSpec, ...] = (
    ...
    ProductSpec("binance", "futures", "BINANCE_FUTURES_API", (
        ...
        RestCase("ticker_24h", "fapi.binance.com", "/fapi/v1/ticker/24hr",
                 rest_contract="binance_ticker24h", expected_symbol="BTCUSDT",
                 core_anchor="src/src/exchanges/binance/fapi/ReferenceCatalogV1.hpp",
                 parser_anchor="src/src/exchanges/transform/binance/fapi/tickers/TransformTickers.hpp"),
        RestCase("funding_current", "fapi.binance.com", "/fapi/v1/premiumIndex",
                 rest_contract="binance_funding", expected_symbol="BTCUSDT",
                 core_anchor="src/src/exchanges/binance/fapi/funding/FundingCurrentCatalog.hpp"),
        RestCase("funding_lowercase", "fapi.binance.com", "/fapi/v1/premiumIndex?symbol=btcusdt",
                 rest_contract="binance_funding", expected_symbol="BTCUSDT",
                 expected_logical_success=False),
    ...
    ProductSpec("bybit", "futures", "BYBIT_FUTURES_API", (
        ...
        RestCase("ticker_24h", "api.bybit.com", "/v5/market/tickers?category=linear",
                 rest_contract="bybit_ticker24h", expected_symbol="BTCUSDT",
                 core_anchor="src/src/exchanges/bybit/linear/ReferenceCatalogV1.hpp"),
        RestCase("funding_current", "api.bybit.com", "/v5/market/tickers?category=linear",
                 rest_contract="bybit_funding", expected_symbol="BTCUSDT",
                 core_anchor="src/src/exchanges/bybit/linear/FundingCurrentCatalogV1.hpp"),
        RestCase("funding_lowercase", "api.bybit.com", "/v5/market/tickers?category=linear&symbol=btcusdt",
                 rest_contract="bybit_funding", expected_symbol="BTCUSDT",
                 expected_logical_success=False),
    ...
    ProductSpec("okx", "futures", "OKX_FUTURES_API", (
        ...
        RestCase("ticker_24h", "www.okx.com", "/api/v5/market/tickers?instType=SWAP",
                 rest_contract="okx_ticker24h", expected_symbol="BTC-USDT-SWAP",
                 core_anchor="src/src/exchanges/okx/swap/ReferenceCatalogV1.hpp"),
        RestCase("funding_current", "www.okx.com", "/api/v5/public/funding-rate?instId=BTC-USDT-SWAP",
                 rest_contract="okx_funding", expected_symbol="BTC-USDT-SWAP",
                 core_anchor="src/src/exchanges/okx/swap/FundingCurrentCatalogV1.hpp"),
        RestCase("funding_lowercase", "www.okx.com", "/api/v5/public/funding-rate?instId=btc-usdt-swap",
                 rest_contract="okx_funding", expected_symbol="BTC-USDT-SWAP",
                 expected_logical_success=False),
    ...
    ProductSpec("gate", "futures", "GATE_FUTURES_API", (
        ...
        RestCase("ticker_24h", "api.gateio.ws", "/api/v4/futures/usdt/tickers",
                 rest_contract="gate_ticker24h", expected_symbol="BTC_USDT",
                 core_anchor="src/src/exchanges/gate/usdt/ReferenceCatalogV1.hpp"),
        RestCase("funding_current", "api.gateio.ws", "/api/v4/futures/usdt/contracts",
                 rest_contract="gate_funding", expected_symbol="BTC_USDT",
                 core_anchor="src/src/exchanges/gate/usdt/FundingCurrentCatalogV1.hpp"),
        RestCase("funding_lowercase", "api.gateio.ws", "/api/v4/futures/usdt/contracts/btc_usdt",
                 rest_contract="gate_funding", expected_symbol="BTC_USDT",
                 expected_logical_success=False),
    ...
    ProductSpec("kucoin", "futures", "KUCOIN_UTA_API", (
        ...
        RestCase("ticker_24h", "api.kucoin.com", "/api/ua/v1/market/ticker?tradeType=FUTURES",
                 rest_contract="kucoin_ticker24h", expected_symbol="XBTUSDTM",
                 core_anchor="src/src/exchanges/kucoin/uta/ReferenceCatalogV1.hpp"),
        RestCase("ticker_lowercase", "api.kucoin.com", "/api/ua/v1/market/ticker?tradeType=FUTURES&symbol=xbtusdtm",
                 rest_contract="kucoin_ticker24h", expected_symbol="XBTUSDTM",
                 expected_logical_success=False),
        ...
        RestCase("funding_current", "api-futures.kucoin.com", "/api/v1/contracts/active",
                 rest_contract="kucoin_funding", expected_symbol="XBTUSDTM",
                 core_anchor="src/src/exchanges/kucoin/uta/FundingCurrentCatalogV1.hpp"),
    ...
    ProductSpec("bitget", "futures", "BITGET_FUTURES_API", (
        RestCase("instrument_rules", "api.bitget.com", "/api/v3/market/instruments?category=USDT-FUTURES"),
        RestCase("ticker_24h", "api.bitget.com", "/api/v3/market/tickers?category=USDT-FUTURES",
                 rest_contract="bitget_ticker24h", expected_symbol="BTCUSDT",
                 core_anchor="src/src/exchanges/bitget/uta/ReferenceCatalogV1.hpp"),
        RestCase("funding_current", "api.bitget.com", "/api/v3/market/current-fund-rate?category=USDT-FUTURES",
                 rest_contract="bitget_funding", expected_symbol="BTCUSDT",
                 core_anchor="src/src/exchanges/bitget/uta/FundingCurrentCatalogV1.hpp"),
        RestCase("funding_lowercase", "api.bitget.com", "/api/v3/market/current-fund-rate?category=USDT-FUTURES&symbol=btcusdt",
                 rest_contract="bitget_funding", expected_symbol="BTCUSDT"),
    ...
    ProductSpec("aster", "futures", "ASTER_FUTURES_API", (
        RestCase("instrument_rules", "fapi.asterdex.com", "/fapi/v3/exchangeInfo"),
        RestCase("ticker_24h", "fapi.asterdex.com", "/fapi/v1/ticker/24hr",
                 rest_contract="binance_ticker24h", expected_symbol="BTCUSDT",
                 core_anchor="src/src/exchanges/aster/fapi/ReferenceCatalogV1.hpp"),
        RestCase("funding_current", "fapi.asterdex.com", "/fapi/v3/premiumIndex",
                 rest_contract="binance_funding", expected_symbol="BTCUSDT",
                 core_anchor="src/src/exchanges/aster/fapi/funding/FundingCurrentCatalog.hpp"),
        RestCase("funding_lowercase", "fapi.asterdex.com", "/fapi/v3/premiumIndex?symbol=btcusdt",
                 rest_contract="binance_funding", expected_symbol="BTCUSDT",
                 expected_logical_success=False),
        RestCase("funding_history", "fapi.asterdex.com", "/fapi/v3/fundingRate?symbol=BTCUSDT&limit=10"),
